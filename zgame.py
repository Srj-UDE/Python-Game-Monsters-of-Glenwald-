import random
from time import sleep #cite origins # To induce delay in the code for game related features
from project.zchar import winning_monster2,monster2,winning_hero4,winning_monster_dead,winning_hero_deto,glenwald_kingdom, monster4, monster5, monster9_, monsterv1,wsage,winning_monster_dead2,winning_monster_scrum3,monster15,monster9,monster11,monster10_8,winning_hero_scrum,monster14
from project.zhero import hero0, hero_su_c,hero_stance, hero_su, herot0
from rich.console import Console # To get coloured statements in the terminal window #cite the origins of this
from rich.panel import Panel #For boxes in the game title
from rich import box #cite the origins
from project.zscrabble import scramble # A function that convert normal words into scrabbled words in a random order
from inputimeout import inputimeout, TimeoutOccurred #Cite origins of this technique # To have stopwatch to make user input time dependent and add time pressure in the game.
from project.zanimation2 import sword_attack, sword_attack2,deto_att,deto_att2,deto_win, sceptre_ani
from project.zanimation1 import thunder, meteor, hero_att, hail_att,unicorn,pegasus,poison_att,fire_att,win,boss2
from project.zboss import veldrek_win
...
def start():
    ...
    #introduce the monsters
            print(monster4)
            c.print("VELDREK - the vampire king! \n\nHe is the leader of the monsters, who is known for his ruthlessness and powerful cannon blasts!",style = "yellow")
            print("------------------------------------------------------------------")
            sleep(6)
            print(monster5)
            c.print("DETONARCH - the destroyer! \n\nRight hand of King VELDREK. Known for his destructive bombs that he carries in his chest!", style="yellow")
            print("------------------------------------------------------------------")
            sleep(5)
            print(monster9_)
            c.print("SCRUM - alien insectoid from beyond the stars! \n\nGeneral of King VELDREK's army. He is the most intelligent and only wits and fast thinking can defeat him. ", style="yellow")
            print("------------------------------------------------------------------")
            sleep(5)
            print(monsterv1)
            c.print("GRINWRECK - the laughing ghoul that feeds on fear! \n\nCommander in the army of VELDREK. ", style="yellow")
            print("------------------------------------------------------------------")
            sleep(5)
                ...
                if wh<=0 and life > 0:
                    ...
                    while life >0:
                        ...
                        if renew_life == "0":
                            ...
                            sleep(1)
                            life-=1
                            action2(life,wh=160,wa=50,mh=250,ma=40)
                            return life
                        else:
                            print("Invalid input. Try again..")
                elif wh<=0 and life == 0:
                ...
                if wh<=0 and life > 0:
                    ...
                    while life >0:
                        ...
                        if renew_life == "0":
                            ...
                            sleep(1)
                            life-=1
                            action3(life,wh=200,wa=90,mh=290,ma=80)
                            return life
                        else:
                            print("Invalid input. Try again..")
                elif wh<=0 and life == 0:
...
def veldrek_moves(life,wh,mh,curse,pd,poison_damage,ars,ts,ms,mb):
    ...
    if n==1:
        ...
        c.print("\nVELDREK used Fire Blast! ( Damage: 180 | accuracy: 60 % )", style="red")
        if acc<7:
            sleep(1.5)
            fire_att()
            wh-=180
            if wh<=0 and life > 0:
                ...
                boss2()
                return
            c.print(f"\nKing health decreased... by '180' points 💥", style= "red")
        else:
            sleep(2.5)
            c.print("\nVELDREK's attack missed!", style="green")
    elif n==2:
        acc=random.randint(1,10)
        c.print("\nVELDREK used Ice Blast! ( Damage: 120 | accuracy: 70 % )", style="red")
        if acc<8:
            sleep(1.5)
            hail_att()
            wh-=120
            if wh<=0 and life > 0:
                ...
                boss2()
                return
            c.print(f"\nKing health decreased... by '120' points 💥", style= "red")
        else:
            sleep(2.5)
            c.print("\nVELDREK's attack missed!", style="green")
    else:
    ...
    if curse == True:
        ...
        if vampire_curse == 5 :
            ...
            sleep(5)
            c.print("\n👿 VELDREK's health increased by '300' points!", style ="red")
            mh+=300
            sleep(2)
            print("\nMonster health 👿 :",mh)
            print("King health 🧔    :",wh)
...
def hero_moves(life,ars,ts,ms,wh,mh,curse,pd,poison_damage,mb):
    ...
    while True:
        ...
        c.print(p.fit(f"ARROW STRIKE: Press 'AS'\n------------------------------------------------------\nDamage: 80 | Accuracy: 80% | Attacks left: {10*'➶'}", style="bright_white", box=box.ROUNDED))
        ...
        if start3 == "0":
            ...
            while True:
                ...
                if read == "r":
                    ...
                    sleep(7)
                    c.print('\n..as you have the favour of Gods, you would get a "HINT" which will help you get the magic word...', style="magenta" )
                    sleep(8)
        ...
        if start3 == "0":
            ...
            while True:
                ...
                if listen == "l":
                    ...
                    sleep(3)
                    c.print("\n..I have been called upon by the priests to guide you in battle with DETONARCH..", style="magenta")
                    sleep(7)
...
def level4(life):
    ...
    while True:
        ...
        if read == "r":
            ...
            sleep(7)
            c.print("\nOut of these be specially careful of the poison blast, which tends to poison its receiver for 3 turns and deals damage every turn", style="magenta")
            sleep(7)
            ...
            sleep(8)
            c.print('\nAlthough VELDREK is immmune to sword attacks...he is susceptible to arrow attacks..', style="magenta")
            sleep(7)
